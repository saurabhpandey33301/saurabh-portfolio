  ...
  return (
    <div className="max-w-full min-h-screen">
      <ReactLenis root>
        ...
        <section className="followUp max-w-full h-[400px] flex justify-center items-center bg-no-repeat bg-center bg-contain overflow-hidden"></section>
        ...
        {/* Footer Section */}
        <footer className="footer w-full border-t flex justify-center items-center h-auto md:h-[300px] px-4 md:px-16">
          <Footer />
        </footer>
      </ReactLenis>
    </div>
