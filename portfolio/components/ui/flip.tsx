...
import { SiAmazon, SiGithub, SiGmail,  SiLeetcode, SiLinkedin, SiX } from "react-icons/si";
import { twMerge } from "tailwind-merge";

export const DivOrigami = () => {
  return (
    <section className="flex max-h-20 flex-col items-center justify-center gap-12 bg-[#1d1d1d] px-4 py-24 md:flex-row">
      <LogoRolodex
        items={[
