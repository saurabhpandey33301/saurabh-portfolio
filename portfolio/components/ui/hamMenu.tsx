...
//                     <Link href={"#about"} className="flex items-end gap-2 text-gray-300 font-mono"> <img src={m.src} alt="" className="w-[55px] h-[55px]" /></Link>
//                     <Link href={"#skills"} className="flex items-center gap-2 text-gray-300 font-mono transform translate-y-4 -translate-x-4"> <img src={s.src} alt="" className="w-[50px] h-[50px]" />  </Link>
//                     <Link href={"#projects"} className="flex items-center gap-2 text-gray-300 font-mono transform -translate-y-10 -translate-x-4"> <img src={p.src} alt="" className="w-[60px] h-[60px]" /> </Link>
//                     <Link href={"#hero"} className="flex gap-2 text-gray-300 font-mono"> <img src={h.src} alt="" className="w-[45px] h-[45px]" /> </Link>
...
//         </AnimatePresence>
//         <motion.button
//           className="w-[105px] h-[103px] bottom-0 right-0 bg-[#ccc] text-white rounded-tl-full shadow-lg relative z-10 flex items-end justify-end  "
